...
#Headings for output file
    ...
    if scopusused == 'Yes':
        ...
        for line in scodata:
            ...
            if len(scopusdoi)>1 and scopusdoi not in scopusdict:
                scopusdict[scopusdoi] = (scopusauthors,scopusreprintauthor,scopuslocalauthors,scopuslocalauthorcount,scopuslocalreprintauthor,scopuslocalreprintauthoraddress,scopusfunders,scopusfullauthors,scopuscitations)
    ...
    for line in records:
        ...
        postarchiving =  ''; postembargo =  '';publishedarchiving =  '';publishedembargo =  '';sherpalink =  '';citations =  '';freetexturl =  '';inwos =  '';inscopus = '';apccharged =  '';doajcurrency =  '';doajprice =  '';
                ...
                if 'Resource not found' not in crossrefpage:
                    ...
                    if int(year)  >= startyear-2 and int(year)  <= endyear+2:
                        ...
                        #Continue with the input for unpaywall for valid DOIs. Information on data fields at https://unpaywall.org/data-format
                            ...
                            if '"license": ' not in oainfo or '"license": null' in oainfo:
                                licence = ''
                            else:
                            ...
                            if '"host_type": "' in oainfo:
                                hostbegin = oainfo.find('"host_type": "')+14
                            ...
                            if '"has_repository_copy": true' in oainfo:
                                ...
                                repstart = oainfohold.find('{')

                                
                                instancecount = oainfohold.count('"oa_date":')
                                

                                for i in range(instancecount):
                                    startrepdata = oainfohold.find('{',repstart)
                                    #endrepdata = oainfo.find('"oa_date"',startrepdata)
                                    endrepdata = oainfohold.find('},',startrepdata)
                                    repdata = oainfohold[startrepdata:endrepdata]
                                    ...
                                    #next = oainfohold.find('"endpoint_id":',pmhend+14)
                                ...
                                for issn in issnlist:
                                    ...
                                    if sherpafound == 'No':
                                        ...
                                        if issn in sherpadict:
                                                ...
                                                if 'Accepted Version' in sherpadata:
                                                    ...
                                                    for i in range(acceptedcount):
                                                        ...
                                                        if ('Institutional Repository' in accepteddata or 'Any Website' in accepteddata or 'Non-Commercial Repository' in accepteddata) and 'Prerequisite' not in accepteddata and 'Open Access fee' not in accepteddata:
                                                            ...
                                                            postembargo =  acceptedinrepositorydata[embargostart:embargoend]
                                                           
                                                            if 'm' in postembargo:
                                                                postembargo =  postembargo.replace('m',' months')
                                                                potentialaam = 'e'
                                                            if 'None' in postembargo:
                                                                potentialaam = 'y'
                                            ...
                                            if 'Published Version' in sherpadata:
                                                ...
                                                for i in range(publishedcount):
                                                    ...
                                                    if ('Institutional Repository' in publisheddata or 'Any Website' in publisheddata or 'Non-Commercial Repository' in publisheddata) and 'Prerequisite' not in publisheddata and 'Open Access fee' not in publisheddata:
                                                        ...
                                                        #print(publishedinrepositorydata)
                                            ...
                                            sherpadict[issn] = (postarchiving, postembargo, publishedarchiving, publishedembargo, potentialaam, potentialpdf, sherpalink)
...
if notinsherpacount>0:
    fout6.write('Replace the existing sherpalist.csv file in the input_files folder with the one generated by this iteration\n')
fout6.write('\n')
