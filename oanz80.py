...
#Headings for output file
    ...
    #Note May 2019 List downloaded from wayback machine https://web.archive.org/web/*/https://doaj.org/csv

    doajfilestring = 'doajlist.csv'
                ...
                if 'Resource not found' not in crossrefdata:
                    ...
                    for yearprefix in yearprefixlist:
                        ...
                        if yearprefix in crossrefdata:
                            ...
                            year = crossrefdata[beginyear:beginyear+4]
